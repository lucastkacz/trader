...
def test_flat_signal_when_zscore_inside_threshold():
    ...
    result = evaluate_signal(
        df_a, df_b, entry_z=2.0, exit_z=0.0, lookback_days=14, current_side=None
    )
...
def test_hold_when_already_in_position():
    ...
    result = evaluate_signal(
        ...
        lookback_days=14, current_side="LONG_SPREAD"
    )
...
def test_volatility_parity_weights_sum_to_one():
    ...
    result = evaluate_signal(
        df_a, df_b, entry_z=2.0, exit_z=0.0, lookback_days=14
    )
